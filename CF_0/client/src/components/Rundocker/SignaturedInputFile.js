...
const SignaturedInputFiles = ({ dataStorage }) => {
  ...
  return (
    <div className="screen-main-div">
      <UpdateSF
        ...
        dataStorage={dataStorage.DS[0].d[1].FS[3].f[1].ES}
      />
      <DeleteSF
      ...
      <div className="list-container">
        ...
        {dataStorage.DS[0].d[1].FS[3].f[1].ES.map((data, i) => (
          <div key={i}>
            <ContextItemRow
              signatured_file={true}
              data={data}
...
export default SignaturedInputFiles;
