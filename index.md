...
Contextflow is based on the proposition that there are three kinds of mental elements invoved in an intentionality of a software developer . These are
       ...
       iii.Entity sequence ,one or more enties attached to a Flow  where each entity has a name and can hold a value of arbitrary kind. Entities work as a            container of the subject matter in a narrow scope.  
           The content of these entities are the code and resources or a pointer to code and resources that make up the software. This way both the POF and            Flows act as addresses to the actual code andresources held by the entities.
